...
from RIL import image, ImageDrow, ImageFont
...
draw = ImageDrow.Drow(image)

font = ImageFont.truetype('arial.ttf', size=70)

text = drow.textbbox((0, 0), top_text)
text_wigth = text[2]

draw.text(((wigth - text_wigth) / 2, 10), top_text, font=font, fill='black')

text = drow.textbbox((0, 0), bottom_text)
text_wigth = text[2]
text_height = text[3]

draw.text(((wigth - text_wigth) / 2, height - text_height - 10), bottom_text, font=font, fill='black')
